...
export class DataComponent {
  ...
  historyData: Data;
  data: Data[] = [];
  displayedColumns: string[] = ['numero', 'moneda', 'precioVivienda', 'cuotaInicial', 'tasaEfectiva', 'numeroCuotas',
  'periodoGraciaTotal', 'periodoGraciaParcial', 'cuota', 'tir', 'tasadescuento', 'tcea', 'van'];
